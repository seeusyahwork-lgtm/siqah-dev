...
const menuItems = [
  ...
  { name: "Notifikasi", icon: Bell, path: "/petugas-kandang/notifikasi" },
  { name: "Pengaturan", icon: Settings, path: "/petugas-kandang/pengaturan" },
];

export default function SidebarPetugasKandang() {
