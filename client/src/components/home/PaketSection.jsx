...
const PaketSection = () => {
  const paketData = [
    {
      ...
      harga: "Rp3.000.000",
      deskripsi: "Daging kambing pilihan, sate & gulai, lengkap dengan nasi kebuli.",
      gambar: "https://res.cloudinary.com/dcida9qys/image/upload/v1761262212/paket-premium_y5pyhe.jpg",
    },
    {
      id: 2,
      ...
      gambar: "https://res.cloudinary.com/dcida9qys/image/upload/v1761262212/paket-standar_wzcoek.jpg",
    },
    {
      id: 3,
      ...
      gambar: "https://res.cloudinary.com/dcida9qys/image/upload/v1761262212/paket-hemat_ebt8wa.jpg",
    },
  ];
  ...
  return (
    ...
    >
      {/* Background Accent (lembut dan tidak mengganggu) */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-[#45624B]/80 font-montserrat max-w-2xl mx-auto">
            ...
            untuk membantu keluarga Muslim merayakan kelahiran dengan penuh berkah dan kemudahan.
          </p>
        </motion.div>
