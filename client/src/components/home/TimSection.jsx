...
const TimSection = () => {
  return (
    <section className="relative py-20 px-6 md:px-16 bg-gradient-to-b from-[#fefbf7] to-[#f9f6ef] overflow-hidden">
      {/* Background Accent */}
      ...
      {/* Glow Light */}
      <div className="absolute w-96 h-96 bg-[#B9914D]/20 rounded-full blur-3xl bottom-10 right-10"></div>
